...
int main(void)
{
  ...
  reg_value = test_reg16;
  reg_value = set_bit(reg_value, A0_BIT_MASK);
  ...
  // enter your code here for problem 1
  reg_value = test_reg16;
  clear_bit(reg_value, PIE_BIT_MASK);
  clear_bit(reg_value, EME_BIT_MASK);
  clear_bit(reg_value, RD_BIT_MASK);
  clear_bit(reg_value, MD_BIT_MASK);
  clear_bit(reg_value, CRS_BIT_MASK);
  clear_bit(reg_value, MODE_01_BIT_VALUE);
  clear_bit(reg_value, MODE_10_BIT_VALUE);
  clear_bit(reg_value, MODE_BIT_MASK);
  clear_bit(reg_value, PRS_BIT_MASK);
  clear_bit(reg_value, A0_BIT_MASK);
